<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item v-if="role != 'common'" label="训练姓名" prop="traName">
        <el-input
      ...
      <el-form-item label="成绩个数" prop="traCount">
        <el-input
    ...
    <el-table v-loading="loading" :data="traGradesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="成绩个数" align="center" prop="traCount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="成绩个数" prop="traCount">
          <el-input v-model="form.traCount" placeholder="请输入成绩个数" />
        </el-form-item>
